...
public class StringUtil {
    public static String applySha256(String input) {
        try {
            ...
            StringBuffer hexString = new StringBuffer(); // This will contain has as hex
    ...
    public static boolean verifyECDSAig(PublicKey publicKey, String data, byte[] signature) {
        try {
